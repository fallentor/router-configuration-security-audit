...
class Client(Iface):
    ...
    def get_config(self, request):
        ...
        """
        self.send_get_config(request)
        return self.recv_get_config()

    def send_get_config(self, request):
...
class Processor(Iface, TProcessor):
    ...
    def process_get_config(self, seqid, iprot, oprot):
        ...
        result = get_config_result()
        try:
            result.success = self._handler.get_config(args.request)
...
get_config_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [ConfigRequest, None], None, ),  # 1
)
...
get_config_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [ConfigResponse, None], None, ),  # 0
)
